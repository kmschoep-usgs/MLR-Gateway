...
public interface LegacyCruClient {
	...
	@RequestMapping(method=RequestMethod.GET, value="monitoringLocations/{id}", consumes="application/json")
	ResponseEntity<String> getMonitoringLocations(@PathVariable("id") String id);
}
